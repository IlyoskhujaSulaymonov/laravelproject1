                ...
                <div class="p-6 text-gray-900">
                    @if (auth()->user()->role->name === 'admin')
                        ...
                        <div class="rounded-xl border p-5 mt-5 shadow-md w-9/12 bg-white">
                            ...
                            <div class="mt-4 mb-6">
                                <div class="mb-3 text-xl font-bold">Nckhcgcgh
                                </div>
                                <div class="text-sm text-neutral-600">ljfhcytckjvh</div>
                            </div>
                        </div>
                        <div class="rounded-xl border p-5 mt-5 shadow-md w-9/12 bg-white">
                            <div class="flex w-full items-center justify-between border-b pb-3">
                            ...
                            <div class="mt-4 mb-6">
                                <div class="mb-3 text-xl font-bold">fhjlfkjhvjkghkj
                                </div>
                                <div class="text-sm text-neutral-600"> asddadadas</div>
                            </div>
                        </div>
